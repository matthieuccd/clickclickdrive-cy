...
const STAGES = {
  el: [
    { num: "1", title: ["Πινακίδες &", "Σημάνσεις"], sub: ["Αναγνώριση", "σημάτων"] },
    { num: "2", title: ["Κανόνες", "Κυκλοφορίας"], sub: ["Προτεραιότητα,", "όρια ταχύτητας"] },
    { num: "3", title: ["Ασφαλής", "Οδήγηση"], sub: ["Αποστάσεις,", "καιρικές συνθήκες"] },
    { num: "4", title: ["Πρώτες", "Βοήθειες"], sub: ["Βασικές", "γνώσεις"] },
  ],
  en: [
    { num: "1", title: ["Road Signs &", "Markings"], sub: ["Sign", "recognition"] },
    { num: "2", title: ["Traffic", "Rules"], sub: ["Priority, speed", "limits"] },
    { num: "3", title: ["Safe", "Driving"], sub: ["Distances, weather", "conditions"] },
    { num: "4", title: ["First", "Aid"], sub: ["Basic", "knowledge"] },
  ],
};
...
export function TheoryTopicsInfographic({ locale }: { locale: Locale }) {
  ...
  return (
    <figure className="my-8 overflow-hidden rounded-2xl bg-[#f3f3f3] p-4">
      <svg
        ...
        className="w-full"
        role="img"
        aria-label={locale === "el" ? "Τι καλύπτει η θεωρητική εξέταση στην Κύπρο" : "What the Cyprus theory test covers"}
      >
        {stages.map((stage, i) => {
      ...
      <p className="mt-2 text-center text-xs text-[#7a8794]">
        {locale === "el" ? "Οι πινακίδες και οι κανόνες κυκλοφορίας καλύπτουν το μεγαλύτερο μέρος των ερωτήσεων" : "Road signs and traffic rules make up most of the exam questions"}
      </p>
    </figure>
  );
}
