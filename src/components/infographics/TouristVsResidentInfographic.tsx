...
const DATA = {
  el: {
    title: "Τουρίστας ή μόνιμος κάτοικος;",
    caption: "Οι κανόνες της βρετανικής άδειας διαφέρουν ανάλογα με την κατάστασή σας",
    left: { heading: "Τουρίστας", sub: ["Ισχύει καθ' όλη", "τη διαμονή σας"] },
    right: { heading: "Μόνιμος Κάτοικος", sub: ["Απαιτείται ανταλλαγή", "εντός προθεσμίας"] },
  },
  en: {
    title: "Tourist or resident?",
    caption: "UK licence rules differ depending on your status",
    left: { heading: "Tourist", sub: ["Valid for your", "whole stay"] },
    right: { heading: "Resident", sub: ["Must exchange", "within deadline"] },
  },
};
...
export function TouristVsResidentInfographic({ locale }: { locale: Locale }) {
  const d = DATA[locale];
